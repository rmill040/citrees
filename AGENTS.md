...
# Experiment CLI and Paper Infrastructure

The `citrees-exp` CLI, the two-stage pipeline, the distributed API/worker
architecture, and all paper experiment guidance live in `paper/AGENTS.md`. Read
that file before working under `paper/`.
