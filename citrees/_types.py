...
# The adaptive stopping rule's null size is an exact Polya-urn computation
# (paper/theory/adaptive_stopping_size.py): 0.0488 for confidence 0.95 and
# 0.0522 for confidence 0.80 at a nominal 0.05 with 999 permutations. Values
# below 0.95 are therefore not accepted.
type ConfidenceFloat = Annotated[
    ...
    Field(
        ...
        description=(
            ...
            "(0.0522 at confidence 0.80 for alpha 0.05 and 999 permutations)."
        ),
    ),
]
