...
This is an internal workplan for drafting the full arXiv preprint in LaTeX. Do
...
- Notes source of truth: `paper/notes/notes.md` (messy is fine).
...
Goal: turn `paper/notes/notes.md` Appendix H into:
