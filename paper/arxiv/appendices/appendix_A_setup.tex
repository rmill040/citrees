...
The fixed-node lemma analyzes the exhaustive fixed-$B$ Stage~A reference test.
...
Lemma~\ref{lem:plusone-superuniform} and
...
The fixed-node results in \cref{sec:theory} use Assumptions A0.1--A0.5. Lemma~\ref{lem:plusone-superuniform} proves $+1$ Monte Carlo permutation $p$-value superuniformity. Corollary~\ref{cor:stageA-global-null} gives Stage~A complete-null control, and Corollary~\ref{cor:stageB-maxt} gives complete-null control for the max-type Stage~B test at a fixed node.
