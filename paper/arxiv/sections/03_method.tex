...
\end{equation}
%
where $\operatorname{uargmin}$ breaks ties uniformly at random among minimizers.
...
In fixed-$B$ mode without early stopping, this corresponds to evaluating all
tested features in $F_t$ and selecting the (tie-broken) minimum. When early
stopping is enabled, features may be tested in an ordered scan that can
terminate once significance is achieved; in that case the selected feature need
not be the global minimizer over all of $F_t$.
