...
\begin{itemize}
  ...
  $\tilde p_t^{\mathrm{sel}}=\min(1,m_t p_t^\star)$ under the nodewise global null.
...
\begin{table}[t]
  ...
  \begin{tabular}{@{}p{0.22\linewidth}p{0.30\linewidth}p{0.40\linewidth}@{}}
    ...
    Classical permutation p-value; super-uniform under A0.1--A0.5. \\
    $p_t^\star = \min_{j\in F_t} p_{t,j}$ &
    Stage~A feature selection &
    Not selection-adjusted; Bonferroni decision at a node can be summarized by $\tilde p_t^{\mathrm{sel}}=\min(1,m_t p_t^\star)$ under the nodewise global null. \\
    $p_t^{\mathrm{split}}$ &
