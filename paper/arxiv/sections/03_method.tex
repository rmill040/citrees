...
strict reject/accept rule as checking whether $p_t^\star < \alpha_{\mathrm{sel}}/m_t$.
...
rows. When bootstrap is enabled, each tree draws $n$ indices with replacement
from $\{1,\dots,n\}$ with uniform probabilities $\pi_i = 1/n$
