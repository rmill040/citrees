...
clearest support, and the regression ordering is descriptive. The fixed-node
results give a local guarantee, and the fitted tree and forest rankings are
...
testing rule, and removing them changes the trees that are grown. For ranking quality, forest size matters more than the
...
Stage~B score is a screening statistic rather than a post-selection
$P$-value.
