...
from paper.benchmark.cli.console_output import console, create_table, error, heading, info
...
def api_start(
    ...
    uvicorn.run(
        "paper.benchmark.api.server:app",
        host=host,
        port=port,
        log_level="info",
    )
...
def worker_start(
    ...
    """
    from paper.benchmark.api.worker import run_worker
