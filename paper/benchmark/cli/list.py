...
from paper.benchmark.cli.console_output import console, create_table, format_number, info
...
def datasets(
    ...
    """
    from paper.benchmark.adapters import get_dataset_shape, get_datasets
...
def methods(
    ...
    """
    from paper.benchmark.pipeline import (
        get_all_method_info,
    )
    from paper.benchmark.pipeline.methods import get_method_config_count
