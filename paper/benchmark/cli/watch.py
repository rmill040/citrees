...
from paper.benchmark.cli.console_output import console
...
def _resolve_context(
    ...
    from paper.benchmark.pipeline.methods import METHOD_INFO
...
def run_watch() -> None:
    ...
    from paper.benchmark.pipeline import get_full_method_configs, get_methods
