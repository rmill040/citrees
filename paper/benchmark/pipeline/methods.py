...
from paper.benchmark.pipeline.types import MethodConfig
...
METHOD_INFO: dict[str, MethodInfo] = {
    ...
    "ptest_mc": MethodInfo(
        name="ptest_mc",
        display_name="MC filter",
        description="Multiple-correlation permutation filter",
        category="ptest",
        tasks=frozenset({"classification"}),
    ),
    "ptest_rdc": MethodInfo(
        name="ptest_rdc",
        display_name="RDC filter",
        description="RDC permutation filter",
        category="ptest",
        tasks=frozenset({"classification", "regression"}),
    ),
    "ptest_pc": MethodInfo(
        name="ptest_pc",
        display_name="PC filter",
        description="Pearson-correlation permutation filter",
        category="ptest",
    ...
    "ptest_dc": MethodInfo(
        ...
        description="Distance-correlation permutation filter",
        category="ptest",
        tasks=frozenset({"regression"}),
    ),
    ...
    "dt": MethodInfo(
        name="dt",
        display_name="DT",
        description="Single CART tree importance",
        category="embedding",
        tasks=frozenset({"classification", "regression"}),
    ),
    "rt": MethodInfo(
        name="rt",
        display_name="RT",
        description="Single random-threshold tree importance",
        category="embedding",
        tasks=frozenset({"classification", "regression"}),
    ),
    "rf": MethodInfo(
    ...
    "cpi": MethodInfo(
        name="cpi",
        display_name="CPI",
        description="Correlation-stratified conditional permutation",
        category="wrapper",
        tasks=frozenset({"classification", "regression"}),
    ),
    "rfe": MethodInfo(
        name="rfe",
        display_name="RF-RFE",
        description="Random-forest recursive feature elimination",
        category="wrapper",
        tasks=frozenset({"classification", "regression"}),
    ),
}
