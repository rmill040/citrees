#!/usr/bin/env python3
"""Generate synthetic datasets for the paper experiments.
...
Usage:
    uv run python paper/data_generation/generate_synthetic_datasets.py
"""
...
CLF_OUTPUT_DIR = Path(__file__).resolve().parents[1] / "data" / "classification" / "synthetic"
REG_OUTPUT_DIR = Path(__file__).resolve().parents[1] / "data" / "regression" / "synthetic"
