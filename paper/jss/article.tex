...
in statistics and defaults for each implementation. Computational experiments
vary sample size, predictor count, selector, permutation budget, and forest size
on fixed hardware, reporting elapsed time and peak memory.
