...
cosine columns. In a 5-seed, 5-fold sensitivity analysis on the Wine and Glass
datasets, increasing the count to 20 multiplied median selector time by
3.03$\times$ and 3.05$\times$, while mean balanced accuracy changed by
$-0.0005$ and $-0.0026$.
