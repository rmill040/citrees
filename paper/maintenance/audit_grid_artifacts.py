...
Writes local audit outputs, usually under a scratch or temporary directory:

Outputs:
  - scratch/paper-maintenance/grid_config_audit.csv
  - scratch/paper-maintenance/grid_dataset_audit.csv
  - scratch/paper-maintenance/grid_artifact_audit_summary.json

Usage:
  uv run python paper/maintenance/audit_grid_artifacts.py --local-dir ../data
"""
