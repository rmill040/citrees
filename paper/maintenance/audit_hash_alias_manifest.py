...
Outputs:
  - scratch/paper-maintenance/grid_hash_aliases.csv
  - scratch/paper-maintenance/grid_hash_aliases_summary.json
...
from paper.benchmark.pipeline.config import get_configs as get_current_configs
