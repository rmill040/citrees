...
2,400 regression cells), accumulated across the benchmark
...
`paper/jss/README.md` maps each JSS table to the replication-suite analysis or
builder script that produces it, and lists the tracked CSVs under `tables/` that
the suite does not regenerate.
