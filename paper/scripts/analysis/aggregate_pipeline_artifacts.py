...
Usage:
    ...
    uv run python paper/scripts/analysis/aggregate_pipeline_artifacts.py \
        --local-dir ../data --task all

    # From S3:
    S3_BUCKET=my-bucket uv run python paper/scripts/analysis/aggregate_pipeline_artifacts.py \
        --task classification
