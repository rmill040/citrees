"""Build a fixed-panel figure for the main classification claim.

The main paper now leans on the 14-dataset fixed panel rather than the
changing-support k-trajectory. The figure combines two views:
  1. The full 15-method fixed-panel ordering by mean balanced accuracy.
...
def main() -> None:
    ...
    ax_left.set_title("A. Fixed-panel ordering", fontsize=12, loc="left")
