...
PROFILES: dict[str, FigureRunConfig] = {
    ...
    "paper": FigureRunConfig(
        ...
        highdim_repeats=8,
        highdim_n=1000,
        sample_size_grid=(500, 1000, 2000, 5000, 10000),
    ),
    "huge": FigureRunConfig(
        ...
        n_repeats=25,
        n_jobs=-1,
        n_samples_main=10000,
        n_estimators_forest=300,
        train_fraction=0.8,
        timing_repeats=8,
        timing_n_samples=10000,
        timing_n_features=500,
        highdim_repeats=12,
        highdim_n=2000,
        sample_size_grid=(500, 1000, 2000, 5000, 10000, 20000),
    ),
}
