...
Archived exploratory suite; not part of the current paper-facing rebuild path.
...
Usage:
    uv run python paper/scripts/archive/analysis/fig_benchmark_exploration_suite.py
"""
...
from paper.scripts.analysis.build_dataset_characteristics_table import build_inventory_table
...
def generate_method_roster():
    ...
    roster = [
        {
            "method": "CIF",
            "category": "Embedded (CI)",
            "key_params": "selector=mc, n_est=100, alpha=0.05, Bonferroni",
            "source": "citrees",
        },
        {
            "method": "CIT",
            "category": "Embedded (CI)",
            "key_params": "selector=mc, alpha=0.05, Bonferroni",
            "source": "citrees",
        },
        {
            "method": "RF",
            "category": "Embedded",
            "key_params": "n_est=100, max_features=sqrt",
            "source": "scikit-learn",
        },
        {
            "method": "ExtraTrees",
        ...
        },
        {
            "method": "XGBoost",
            "category": "Embedded",
            "key_params": "n_est=100, importance=total_gain",
            "source": "xgboost",
        },
        {
            "method": "LightGBM",
            "category": "Embedded",
            "key_params": "n_est=100, importance=gain",
            "source": "lightgbm",
        },
        {
            "method": "CatBoost",
            "category": "Embedded",
            "key_params": "n_est=100, importance=PredictionValuesChange",
            "source": "catboost",
        },
        {
            "method": "Boruta",
            "category": "Wrapper",
            "key_params": "RF-based, max_iter=100",
            "source": "boruta",
        },
        {
            "method": "RFE",
            "category": "Wrapper",
            "key_params": "RF estimator, step=0.1",
            "source": "scikit-learn",
        },
        {
            "method": "PI",
            "category": "Wrapper",
            "key_params": "RF permutation importance, n_repeats=10",
            "source": "scikit-learn",
        },
        {
            "method": "CPI",
            "category": "Wrapper",
            "key_params": "Conditional permutation importance",
            "source": "scikit-learn",
        },
        {
            "method": "MC-ptest",
            "category": "Filter (perm)",
            "key_params": "Multiple correlation + permutation test",
            "source": "citrees",
        },
        {
            "method": "RDC-ptest",
            "category": "Filter (perm)",
            "key_params": "Randomized dependence coefficient + perm",
            "source": "citrees",
        },
        {
            "method": "R-ctree",
            "category": "Embedded (CI)",
            "key_params": "partykit::ctree, Bonferroni",
            "source": "R partykit",
        },
        {
            "method": "R-cforest",
            "category": "Embedded (CI)",
            "key_params": "partykit::cforest, ntree=100, varimp",
            "source": "R partykit",
        },
    ]
