...
Usage:
    uv run python -m paper.scripts.archive.experiments.study_ptest_power_grid
"""
    ...
    for alpha in ALPHA_GRID:
        for B in B_GRID:
            for stopping_label, stopping_val in [("adaptive", "adaptive"), ("fixed_B", None)]:
                ...
                print(
                    f"  alpha={alpha:.2f}, B={B:>4d}, {stopping_label:>10s}: "
        ...
        for class_sep in CLASS_SEP_GRID:
            for B in B_GRID:
                for stopping_label, stopping_val in [("adaptive", "adaptive"), ("fixed_B", None)]:
                    ...
                    print(
                        f"    sep={class_sep:.1f}, B={B:>4d}, {stopping_label:>10s}: "
                        f"power={power:.3f}"
                    )
