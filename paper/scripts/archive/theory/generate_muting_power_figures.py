...
Usage:
    uv run python paper/scripts/archive/theory/generate_muting_power_figures.py
    uv run python paper/scripts/archive/theory/generate_muting_power_figures.py --output-dir paper/results/figures
"""
