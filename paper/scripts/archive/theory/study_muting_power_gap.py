...
Usage:
    ...
    uv run python paper/scripts/archive/theory/study_muting_power_gap.py --quick

    # Full validation
    uv run python paper/scripts/archive/theory/study_muting_power_gap.py

    # Custom parameters
    uv run python paper/scripts/archive/theory/study_muting_power_gap.py --n 2000 --p 0.05 --n-sims 500
"""
