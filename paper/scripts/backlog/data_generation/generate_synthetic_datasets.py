...
Archived generator; not part of the current paper-facing rebuild path.
...
Usage:
    uv run python paper/scripts/backlog/data_generation/generate_synthetic_datasets.py
"""
