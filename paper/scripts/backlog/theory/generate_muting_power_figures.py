...
Archived theory figure generator; not part of the current paper-facing rebuild path.
...
Usage:
    uv run python paper/scripts/backlog/theory/generate_muting_power_figures.py
    uv run python paper/scripts/backlog/theory/generate_muting_power_figures.py --output-dir paper/results/figures
"""
