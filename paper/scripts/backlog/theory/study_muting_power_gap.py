...
Archived theory study; not part of the current paper-facing rebuild path.

This script validates the theoretical predictions from muting_power_theory.py
...
Usage:
    ...
    uv run python paper/scripts/backlog/theory/study_muting_power_gap.py --quick

    # Full validation
    uv run python paper/scripts/backlog/theory/study_muting_power_gap.py

    # Custom parameters
    uv run python paper/scripts/backlog/theory/study_muting_power_gap.py --n 2000 --p 0.05 --n-sims 500
"""
...
from paper.scripts.theory.muting_power_theory import (
    find_gap_region,
    gate_power,
    root_power,
)
