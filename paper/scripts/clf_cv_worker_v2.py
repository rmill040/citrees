"""Classifier metrics - WORKER v2.

Improvements:
- Multiple downstream models (SVM, LR, kNN)
- More efficient CV with pre-computed folds
...
def run(url: str) -> None:
    ...
    ddb_table_s = boto3.resource("dynamodb", region_name="us-east-1").Table(os.environ["TABLE_NAME"] + "MetricsV2")
    ddb_table_f = boto3.resource("dynamodb", region_name="us-east-1").Table(os.environ["TABLE_NAME"] + "MetricsV2Fail")
