...
METHOD_INFO: dict[str, MethodInfo] = {
    ...
    "cpi": MethodInfo(
        name="cpi",
        display_name="CPI approximation",
        description="Stratified conditional-permutation approximation",
        category="wrapper",
        tasks=frozenset({"classification", "regression"}),
    ),
    "rfe": MethodInfo(
        name="rfe",
        display_name="Random-forest RFE",
        description="Random-forest backward elimination",
        category="wrapper",
        tasks=frozenset({"classification", "regression"}),
    ),
}
