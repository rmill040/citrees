"""Comprehensive p-value calibration under a complete global null.
...
---
  UV_CACHE_DIR=./scratch/.uv_cache uv run python \
      paper/scripts/theory/generate_comprehensive_calibration.py

  # Quick mode (fewer sims):
  UV_CACHE_DIR=./scratch/.uv_cache uv run python \
      paper/scripts/theory/generate_comprehensive_calibration.py --quick
"""
